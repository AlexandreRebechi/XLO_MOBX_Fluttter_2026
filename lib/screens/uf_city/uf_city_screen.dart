...
class UfCityScreen extends StatefulWidget {
  const UfCityScreen({super.key, this.uf, this.showAll = false});

  final UF? uf;
  final bool showAll;

  @override
  _UfCityScreenState createState() => _UfCityScreenState(uf as UF, showAll);
}
                    ...
                    child: Observer(
                      builder: (_) {
                        if (ufCityStore.error != null)
                          return ErrorBox(message: ufCityStore.error);
