...
mixin _$CepStore on _CepStore, Store {
  ...
  late final _$_CepStoreActionController = ActionController(
    name: '_CepStore',
    context: context,
  );
  ...
  void setCep(String value) {
    final _$actionInfo = _$_CepStoreActionController.startAction(
      name: '_CepStore.setCep',
    );
    try {
