...
mixin _$LocationStore on _LocationStore, Store {
  ...
  @override
  bool get showLocationScreen =>
      (_$showLocationScreenComputed ??= Computed<bool>(
        () => super.showLocationScreen,
  ...
  bool get exitLocationScreen =>
      (_$exitLocationScreenComputed ??= Computed<bool>(
        () => super.exitLocationScreen,
        name: '_LocationStore.exitLocationScreen',
      )).value;
  Computed<bool>? _$readyToFetchAdsComputed;

  @override
  bool get readyToFetchAds => (_$readyToFetchAdsComputed ??= Computed<bool>(
    () => super.readyToFetchAds,
    name: '_LocationStore.readyToFetchAds',
  )).value;

  late final _$locationAtom = Atom(
    name: '_LocationStore.location',
    context: context,
  );
