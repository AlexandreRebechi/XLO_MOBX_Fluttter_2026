...
mixin _$CreateStore on _CreateStore, Store {
  ...
  @override
  bool get imageValid => (_$imageValidComputed ??= Computed<bool>(
    () => super.imageValid,
  ...
  @override
  Address? get address => (_$addressComputed ??= Computed<Address?>(
    () => super.address,
    name: '_CreateStore.address',
  )).value;
  Computed<num?>? _$priceComputed;

  @override
  num? get price => (_$priceComputed ??= Computed<num?>(
    () => super.price,
    name: '_CreateStore.price',
  )).value;
  Computed<bool>? _$formValidComputed;

  @override
  bool get formValid => (_$formValidComputed ??= Computed<bool>(
    () => super.formValid,
  ...
  @override
  Function? get sendPressed => (_$sendPressedComputed ??= Computed<Function?>(
    () => super.sendPressed,
  ...
  late final _$priceTextAtom = Atom(
    name: '_CreateStore.priceText',
    context: context,
  );
  ...
  late final _$showErrorsAtom = Atom(
    name: '_CreateStore.showErrors',
    context: context,
  );
  ...
  late final _$savedAdAtom = Atom(
    name: '_CreateStore.savedAd',
    context: context,
  );
  ...
  late final _$_sendAsyncAction = AsyncAction(
    '_CreateStore._send',
    context: context,
  );
  ...
  late final _$_CreateStoreActionController = ActionController(
    name: '_CreateStore',
    context: context,
  );
