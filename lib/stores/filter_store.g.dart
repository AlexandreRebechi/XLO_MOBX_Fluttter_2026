...
mixin _$FilterStore on _FilterStore, Store {
  ...
  late final _$vendorTypeAtom = Atom(
    name: '_FilterStore.vendorType',
    context: context,
  );
  ...
  late final _$ufAtom = Atom(name: '_FilterStore.uf', context: context);
