...
mixin _$MyAdsStore on _MyAdsStore, Store {
  ...
  @override
  List<Ad> get activeAds => (_$activeAdsComputed ??= Computed<List<Ad>>(
    () => super.activeAds,
  ...
  @override
  List<Ad> get pendingAds => (_$pendingAdsComputed ??= Computed<List<Ad>>(
    () => super.pendingAds,
  ...
  @override
  List<Ad> get soldAds => (_$soldAdsComputed ??= Computed<List<Ad>>(
    () => super.soldAds,
    name: '_MyAdsStore.soldAds',
  )).value;
  ...
  late final _$soldAdAsyncAction = AsyncAction(
    '_MyAdsStore.soldAd',
    context: context,
  );
  ...
  late final _$deleteAdAsyncAction = AsyncAction(
    '_MyAdsStore.deleteAd',
    context: context,
  );
