...
mixin _$EditAccountStore on _EditAccountStore, Store {
  ...
  @override
  bool get phoneValid => (_$phoneValidComputed ??= Computed<bool>(
    () => super.phoneValid,
  ...
  @override
  bool get passValid => (_$passValidComputed ??= Computed<bool>(
    () => super.passValid,
  ...
  VoidCallback? get savePressed =>
      (_$savePressedComputed ??= Computed<VoidCallback?>(
        () => super.savePressed,
        name: '_EditAccountStore.savePressed',
      )).value;

  late final _$userTypeAtom = Atom(
    name: '_EditAccountStore.userType',
    context: context,
  );
  ...
  late final _$pass1Atom = Atom(
    name: '_EditAccountStore.pass1',
    context: context,
  );
  ...
  late final _$pass2Atom = Atom(
    name: '_EditAccountStore.pass2',
    context: context,
  );
  ...
  late final _$loadingAtom = Atom(
    name: '_EditAccountStore.loading',
    context: context,
  );
  ...
  late final _$_saveAsyncAction = AsyncAction(
    '_EditAccountStore._save',
    context: context,
  );
  ...
  late final _$_EditAccountStoreActionController = ActionController(
    name: '_EditAccountStore',
    context: context,
  );
