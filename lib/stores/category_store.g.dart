...
mixin _$CategoryStore on _CategoryStore, Store {
  Computed<List<Category>>? _$allCategoryLsitComputed;

  @override
  List<Category> get allCategoryLsit =>
      (_$allCategoryLsitComputed ??= Computed<List<Category>>(
        () => super.allCategoryLsit,
        name: '_CategoryStore.allCategoryLsit',
      )).value;
  ...
  String toString() {
    return '''
error: ${error},
allCategoryLsit: ${allCategoryLsit}
    ''';
  }
}
